...
echo.
if %custominstall_evc%==1 echo 2. [X] Everybody Votes Channel
if %custominstall_evc%==0 echo 2. [ ] Everybody Votes Channel
if %custominstall_nc%==1 echo 3. [X] Nintendo Channel
if %custominstall_nc%==0 echo 3. [ ] Nintendo Channel
if %custominstall_cmoc%==1 echo 4. [X] Check Mii Out Channel / Mii Contest Channel
if %custominstall_cmoc%==0 echo 4. [ ] Check Mii Out Channel / Mii Contest Channel
echo.
echo 5. Begin patching^^!
echo R. Go back.
set /p s=
if %s%==1 goto 2_switch_region_wiiu
if %s%==2 goto 2_switch_evc_wiiu
if %s%==3 goto 2_switch_nc_wiiu
if %s%==4 goto 2_switch_cmoc_wiiu
if %s%==5 goto 2_2_wiiu
if %s%==r goto begin_main
if %s%==R goto begin_main
goto 2_choose_custom_install_type2_wiiu
