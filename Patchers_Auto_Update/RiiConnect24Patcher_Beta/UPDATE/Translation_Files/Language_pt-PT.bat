...
set string40=Se VFF Downloader estiver em execução, desligá-lo.
...
set string53=Desculpa, não existe uma versão beta publica disponível neste momento.
...
set string472=Cada ficheiro está no lugar certo no seu Cartão SD^^!
