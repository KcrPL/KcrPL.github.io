...
set string1=Riiconecteaza-C>i consola Wii.
set string2=AZncepe
set string3=Credite
set string4=SetAri
...
set string11=ReA(r)mprospAteazA
set string12=DacA este incorect, A(r)l poC>i schimba mai tAVrziu.

set string13=AtenC>ie
set string14=FoloseC(tm)ti o versiune experimentalA al acestui program.
set string15=Asta A(r)nseamnA ca aceastA versiune s-ar putea sA conC>inA funcC>ii experimentale
set string16=C(tm)i erori care pot sA-C>i strice consola Wii/Wii U sau calculatorul tAu.
set string17=DacA nu C(tm)tii ce faci, te rugAm sA te duci A(r)n setAri C(tm)i A(r)napoi la
set string18=ramura stabilA a patcherului.

set string19=TasteazA un numAr pe care A(r)l poC>i vedea deasupra lAVngA comandA C(tm)i apasA pe ENTER

set string20=Unelte de depanare
set string21=Aceste unelte ar trebui sA te ajute la diagnosticarea a cAVtorva probleme ale patcherului C(tm)i sA A(r)ncerce sA le repare automat.
set string22=Nu am putut detecta un Card SD.
set string23=Nu am putut copia fiC(tm)ierele cAtre Cardul SD.
set string24=Eroare A(r)n redenumirea fiC(tm)ierelor
set string25=AZntoarce-te A(r)n meniul principal
set string26=Alege

set string27=SetArile patcherului RiiConnect24
set string28=AZntoarce-te
set string29=SeteazA culoarea fundalului/textului
set string30=OpreC(tm)te/porneC(tm)te actualizarea
set string31=Acum
set string32=SchimbA ramura de actualizare cAtre
set string33=Beta
set string34=Stabil
set string35=ReparA fiC(tm)ierul patcherului
set string36=RedescarcA
set string37=VFF Downloader pentru Dolphin SetAri
set string38=Cterge complet VFF Downloader pentru Dolphin din computerul tAu
set string39=Cterge VFF Downloader la pornire
set string40=DacA VFF Downloader ruleazA, opreC(tm)te-l.
set string41=Te rog aC(tm)teaptA... adunarea datelor.
set string42=Vrei sA te A(r)ntorci la o versiune stabilA a patcherului?
...
set string47=Procesul de actualizare va A(r)ncepe.
set string48=Da, schimbA la ramura StabilA.
set string49=[NU AM PUTUT SCHIMBA LA VERSIUNEA STABILA,]
set string50=Nu, du-te A(r)n meniul principal.
set string51=Vrei sA schimbi la o versiune BETA a patcherului?
set string52=Versiune beta
set string53=Scuze, nu este nicio versiune beta publicA disponibilA A(r)ncA.
set string54=Da, schimbA la ramura Beta.
set string55=[NU AM PUTUT SCHIMBA LA VERSIUNEA BETA]

set string56=ACTEAPTA,
set string57=AZncerci sA opreC(tm)ti actualizarea?
set string58=Te rog aminteC(tm)te-C>i faptul cA actualizArile te C>in A(r)n siguranC>A C(tm)i actualizat cu patcherul.
set string59=FoloseC(tm)te aceastA opC>iune doar pentru debugging C(tm)i depanare.
set string60=EC(tm)ti sigur ca vrei sA opreC(tm)ti actualizarile automate?

set string61=Da
set string62=Nu, A(r)ntoarce-te.

set string63=SchimbA culoarea:
set string64=TemA A(r)ntunecatA
set string65=TemA albA *ediC>ia te rog nu A(r)mi rAni ochii*
set string66=TemA albA *ediC>ia te rog rAneC(tm)te-mi ochii*
set string67=Galben
set string68=Verde
set string69=RoC(tm)u
set string70=Albastru

set string71=Descarc curl... Te rog aC(tm)teaptA.
set string72=Poate lua ceva timp...

set string73=EROARE.
set string74=A fost o eroare A(r)n timpul descArcArii curl.
set string75=Vom deschide acum un website care va descArca curl.exe.
set string76=Te rog mutA curl.exe A(r)n folderul unde patcherul RiiConnect24 este aflat C(tm)i restarteazA patcherul.
set string77=ApasA orice tastA pentru a deschide pagina pentru descArcare A(r)n browser C(tm)i pentru a te A(r)ntoarce A(r)n meniu.
...
set string84=RenunC>A
set string85=Ce este nou A(r)n aceastA actualizare?
set string86=Actualizare.
set string87=Te rog aC(tm)teaptA...
set string88=Patcherul RiiConnect24 se va restarta A(r)n curAVnd...
set string89=A fost o eroare A(r)n timpul descArcArii asistentului de actualizare.
set string90=ApasA orice tastA pentru a te A(r)ntoarce A(r)n meniul principal.
set string91=Ce este nou A(r)n actualizare
set string92=Eroare. FiC(tm)ierul ce este nou nu este disponibil.
set string93=ApasA orice tastA pentru a te A(r)ntoarce.
:: Local end

:: Must be available online
set string100=Bun venit la magazinul Homebrew.
set string101=AZnainte sA instalezi o aplicaC>ie homebrew, vrei sA permiC>i instalarea automatA pe SD Cardul tAu?
set string102=Da, detecteaza Cardul SD.
set string103=Nu, o sA le instalez manual.
set string104=Hmm... se pare cA nu s-a gAsit un Card SD A(r)n consola ta. Te rugAm alege opC>iunea "SchimbA litera driveului"
set string105=pentru a seta litera Cardului SD manual.
set string106=Altfel, va trebui sA copiaC>i aplicaC>ia homebrew cAtre Cardul SD manual.
set string107=Bravo^^! Am detectat Cardul tAu SD cu succes^^! Litera driveului:
set string108=O sA pot descArca C(tm)i instala tot pe Cardul tAu SD automat^^!
set string109=Ce urmeazA?
set string110=ContinuA
set string111=IeC(tm)i
...
set string116=Te rog aC(tm)teaptA...
set string117=S-a A(r)ntAVmplat o eroare A(r)n timpul descArcArii Open Shop Channel.
set string118=Codul de IeC(tm)ire CURL
set string119=ApasA orice tastA pentru a te A(r)ntoarce.
set string120=DescArcAtorul Open Shop Channel este pregAtit^^! Ce vrei sA faci acum?
set string121=AratA lista de aplicaC>ii homebrew disponibile.
set string122=DescarcA aplicaC>ii homebrew.
set string25=AZntoarce-te A(r)n meniul principal
set string124=AC(tm)teaptA un moment...
set string125=SFAT: Csine minte numele aplicaC>iei homebrew A(r)n care eC(tm)ti interesatA, A(r)ntoarce-te la program, alege "DescarcA aplicaC>ii homebrew" C(tm)i tasteazA numele.
set string126=AZC>i va arAta o descriere C(tm)i alte informaC>ii importante despre aplicaC>ia homebrew pe care ai ales-o.
set string127=Lista de aplicaC>ii homebrew disponibile
set string128=TasteazA numele aplicaC>iei tale homebrew.
set string129=nu este disponibil A(r)n server.
set string130=Pentru lista de aplicaC>ii homebrew care sunt pe server, te rugam du-te A(r)napoi C(tm)i alege "AratA lista de aplicaC>ii homebrew disponibile".
set string131=Aducem informaC>iile...
set string132=Tu ai solicitat...
set string133=Descriere lungA:
set string134=Vrei sA descarci aceastA aplicaC>ie?
set string135=DacA pornit, va fi instalat automat pe Cardul SD.
set string136=Nu, A(r)ntoarce-te.
set string137=AZn curs de descArcare
set string138= .ZIP A(r)n curs de descArcare
set string139=Gata^^!
set string140= FiC(tm)ierul .ZIP este localizat A(r)n acelaC(tm)i loc cu patcherul RiiConnect24.
set string141=ApasA orice tastA pentru a te A(r)ntoarce.
set string142=7zip CLI A(r)n curs de descArcare
set string143=Extragem aplicaC>ia homebrew A(r)n Cardul tAu SD...
set stringstring144=A fost o eroare A(r)n timpul descArcArii aplicaC>iei homebrew.
set string145=S-a A(r)ntAVmplat o eroare A(r)n timpul descArcArii aplicaC>iei homebrew de la serverele Open Shop Channel.
set string146=S-a A(r)ntAVmplat o eroare A(r)n timpul descArcArii 7zip.
