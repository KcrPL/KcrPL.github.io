...
set string4=InstA$?llningar
set string5=Hantera VFF Downloader fAPr Dolphin hA$?r
set string6=KAPr VFF Downloader en gAAng.
...
set string12=Om nAAgot A$?r fel gAAr det att A$?ndra senare.

set string13=Varning
set string14=Du anvA$?nder en experimentell version av det hA$?r programmet.
set string15=Det betyder att den hA$?r versionen kan innehAAlla experimentella funktioner
set string16=och buggar som kan fAPrstAPra din Wii/Wii U-konsoll eller din dator.
set string17=Om du inte vet vad du gAPr, vA$?nligen gAA tillbaka till
set string18=den stabila grenen av patcharen.

set string19=Skriv ett nummer som du kan se ovanfAPr bredvid kommandot och tryck ENTER

set string20=FelsAPkningsverktyg
set string21=De hA$?r verktygen borde hjA$?lpa dig diagnotisera nAAgra problem med patcharen och fAPrsAPka reparera dem automatiskt.
...
set string25=A...tergAA till huvudmeny
set string26=VA$?lj

set string27=RiiConnect24 Patcher InstA$?llningar
set string28=GAA tillbaka
set string29=A,,ndra bakgrunds/textfA$?rg
set string30=SA$?tt pAA/StA$?ng av uppdatering
set string31=FAPr nA$?rvarande
set string32=Byt uppdateringsgren till
set string33=Beta
set string34=Stabil
set string35=Reparera patcher fil
set string36=Ladda ned Igen
set string37=VFF Downloader fAPr Dolphin InstA$?llningar
set string38=Radera VFF Downloader fAPr Dolphin frAAn din dator
set string39=Radera VFF Downloader frAAn uppstart
set string40=Om VFF Downloader kAPrs, stA$?ng ner.
set string41=VA$?nligen vA$?nta... hA$?mtar data.
set string 42=Vill du gAA tillbaka till den stabila versionen av patchern?
set string43=Aktuell version
set string44=Stabil version
set string45=FAPrlAAt, det blev fel vid hA$?mtningen av data.
...
set string50=Nej, gAA tillbaka till huvudmenyn.
set string51=Vill du byta till BETA-versionen av patcharen?
set string52=Beta version
set string53=FAPrlAAt, det finns fAPr nA$?rvarande ingen offentlig betaversion tillgA$?nglig.
set string54=Ja, byt till Beta grenen.
set string55=[GICK INTE ATT BYTA TILL BETA VERSION]

set string56=VA,,NTA
set string57=FAPrsAPker du stA$?nga av uppdatering?
set string58=VA$?nligen kom ihAAg att uuppdateringar kan hAAlla dig sA$?ker och uppdaterad om patcharen.
set string59=AnvA$?nd bara det hA$?r alternativet fAPr debugging och felsAPkning.
set string60=A,,r du sA$?ker pAA att du vill stA$?nga av autouppdatering?

set string61=Ja
set string62=Nej, gAA tillbaka.

set string63=Byt fA$?rg:
set string64=MAPrkt tema
set string65=Ljust tema *snA$?lla fAPrstAPr inte mina APgon utgAAvan*
set string66=Ljust tema *snA$?lla fAPrstAPr mina APgon utgAAvan*
set string67=Gul
set string68=GrAPn
set string69=RAPd
set string70=BlAA

set string71=Laddar ner lock... VA$?nligen vA$?nta.
set string72=Det hA$?r kan ta lite tid...
