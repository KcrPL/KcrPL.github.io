...
set string2=DA(c)marrer
set string3=CrA(c)dits
set string4=ParamA"tres
set string5=GA(c)rez le TA(c)lA(c)chargeur de VFF pour Dolphin ici
set string6=ExA(c)cuter le TA(c)lA(c)chargeur de VFF une fois.
set string7=Avez-vous des problA"mes ou dA(c)sirez-vous nous contacter?
set string8=Envoyez-nous un courriel A  support@riiconnect24.net
set string9=Carte SD Wii DA(c)tectA(c)e:
set string10=impossible de dA(c)tecter la carte SD de votre Wii.
set string11=RafraA(r)chir
set string12=Si incorrect, vous pourrez les modifier plus tard.

set string13=Attention
set string14=Vous utilisez une version expA(c)rimentale de ce programme.
set string15=Cela veut dire que cette version pourrait contenir des fonctions expA(c)rimentales
set string16=et des bugs qui pourraient casser votre console Wii/Wii U ou votre ordinateur.
set string17=Si vous n'AStes pas certain de ce que vous faites, veuillez retourner A  la section paramA"tres, et retournez A 
set string18=la branche stable du programme.

set string19=Entrez un numA(c)ro affichA(c) ci-dessus A  cA'tA(c) de la commande, et appuyez sur la touche ENTREE

set string20=Outils de dA(c)pannage
set string21=Ces outils vous aideront A  diagnostiquer certains problA"mes avec le programme, et essayera de remA(c)dier ces derniers.
set string22=Impossible de dA(c)tecter la carte SD.
...
set string26=SA(c)lectionnez

set string27=ParamA"tres du Patcher RiiConnect24
set string28=Retourner
set string29=DA(c)finir la couleur de laEUR(tm)arriA"re-plan/du texte
set string30=DA(c)sactiver/Activer les mises A  jour
set string31=Actuellement
set string32=Changer la branche du programme A 
set string33=BASta
set string34=Stable
set string35=RA(c)parer le fichier du patch
set string36=TA(c)lA(c)charger A  nouveau
set string37=TA(c)lA(c)chargeur VFF pour les paramA"tres de Dolphin
set string38=DA(c)sinstaller complA"tement le TA(c)lA(c)chargeur VFF pour Dolphin de votre ordinateur
set string39=Retirer le TA(c)lA(c)chargeur VFF au dA(c)marrage
set string40=Si le TA(c)lA(c)chargeur VFF est lancA(c), fermez le.
set string41=Veuillez patienter... rA(c)cupA(c)ration des donnA(c)es.
...
set string45=DA(c)solA(c), il y a eu une erreur durant la rA(c)cupA(c)ration des donnA(c)es.
...
set string49=[IMPOSSIBLE DE PASSER AEUR LA VERSION STABLE]
set string50=Non, Retourner au menu principal.
set string51=Voulez-vous changer vers la version BETA du patcher?
set string52=Version BASta
set string53=DA(c)solA(c), il n'y a pas de version bASta publique disponible.
set string54=Oui, changer vers la branche bASta.
set string55=[IMPOSSIBLE DE PASSER AEUR LA VERSION BETA]

set string56=ATTENDEZ
set string57=Essayez vous de dA(c)sactiver les mises A  jour?
set string58=S'il vous plaA(r)t retenez que ces mises A  jour vous garderons en sA(c)curitA(c) et A  jour au niveau du patcher.
set string59=Veuillez utiliser cette option pour dA(c)bugger et/ou dA(c)panner.
set string60=Vous AStes sure que vous voulez dA(c)sactiver les mises A  jour automatiques?

set string61=Oui
set string62=Non, retourner en arriA"re.

set string63=Changer la couleur:
set string64=ThA"me sombre
set string65=ThA"me clair *version ne me faites pas mal aux yeux svp*
set string65=ThA"me clair *version brulez moi les yeux*
set string67=Jaune
set string68=Vert
set string69=Rouge
set string70=Bleu

set string71=TA(c)lA(c)chargement de curl... Veuillez patienter.
set string72=Cela peut prendre du temps...

set string73=ERREUR.
set string74=Il y a eu une erreur pendant le tA(c)lA(c)chargement de curl.
set string75=Nous allons ouvrir un site qui tA(c)lA(c)chargera curl.exe.
set string76=Veuillez dA(c)placer curl.exe dans le dossier RiiConnect24 Patcher est redA(c)marrer le patcher.
set string77=Pressez une touche pour ouvrir la page de tA(c)lA(c)chargement dans votre navigateur et pour retourner au menu.

set string78=Recherche de mises A  jour...
set string79=Une mise A  jour est disponible.
set string80=Une mise A  jour pour ce programme est disponible. Nous vous suggA(c)rons de mettre le Patcher A  la derniA"re version.
...
set string88=RiiConnect24 Patcher va redA(c)marrer sous peu...
set string89=Il y a eu une erreur pendant le tA(c)lA(c)chargement de l'assistant de mise A  jour.
...
set string93=Appuyez sur une touche pour retourner en arriA"re.
:: Local end

:: Must be available online
set string100=Bienvenue dans laEUR(tm)Homebrew Shop.
set string101=Avant de tA(c)lA(c)charger un logiciel homebrew, veux-tu activer les installations automatiques sur ta carte SD?
set string102=Oui, Detecter la carte SD.
set string103=Non, je veux les installer manuellement.
set string104=Hmm... aucune carte SD naEUR(tm)a A(c)tA(c) trouvA(c)e dans votre systA"me. S'il vous plait, Veuillez choisir l'option "Change drive letter"
...
set string107=Congrats^^! JaEUR(tm)ai rA(c)ussi A  dA(c)tecter ta carte SD ^^! Drive letter:
...
set string119=Appuyer sur naEUR(tm)importe quel bouton pour revenir.
...
set string124=Une seconde saEUR(tm)il te plait...
...
set string134=Voulez-vous tA(c)lA(c)charger cette application?
set string135=If enabled, it will be automatically installed to the SD Card.
set string136=No, return.
set string137=TA(c)lA(c)chargement en cours
...
set string156=Installez Riiconnect24 sur votre A(c)mulateur Dolphin
set string191=Installez Riiconnect24 sur votre Wii U
set string273=Installez Riiconnect24 sur votre Wii.
set string274=DA(c)sinstaller Riiconnect24 sur votre Wii.
...
set string165=Visiter laEUR(tm)Homebrew Shop
...
set string167=Salut
set string168=Bienvenue sur le laEUR(tm)installateur de RiiConnect24 pour l'A(c)mulateur Dolphin.
set string169=DA(c)jA , j'ai besoin de tA(c)lA(c)charger VFF-Downloader. Ceci va faire fonctionner la ChaA(r)ne MA(c)tA(c)o et la ChaA(r)ne Infos.
set string170=Appuyer sur n'importe quel touche pour tA(c)lA(c)charger et lancer VFF-Downloader pour Dolphin.

set string171=Et voilA ! Je vois que vous AStes sortit de l'installateur de VFF-Downloader.
set string172=Si vous l'avez installA(c) correctement et choisis:
set string173=Manuel - Ceci vas AStre une option dans le menu principal du patch de Riiconnect24. Lancer le A  chaque fois que vous voulez
set string174=accA"s ChaA(r)ne MA(c)tA(c)o et Infos. Il y aura une option dans le menu principal pour contrA'ler VFF Downloader.
set string175=DA(c)marrage - Le programme vas ce lancer et tA(c)lA(c)charger les fichiers toutes les heures.
...
set string181=Nous allons avoir besoin de lancer le correctif pour avoir la ChaA(r)ne Concours Mii et la ChaA(r)ne Vote.
set string182=Quelle rA(c)gion dois-je tA(c)lA(c)charger?
set string183=Europe
set string184=A%0tats-Unis
set string185=CaEUR(tm)est fini ^^! Maintenant, veuillez saEUR(tm)il vous plaA(r)t ouvrir laEUR(tm)A(c)mulateur Dolphin, appuyer sur le bouton outils et installer le fichier WAD qui a A(c)tA(c) tA(c)lA(c)chargA(c) dans le dossier WAD 
set string186=AprA"s le Correctif RiiConnect24.
set string187=C'est Fini ^^!
set string188=qu'est-ce que nous faisons aprA"s?
...
set string202=Express (RecommandA(c))
set string203=Ce patch va corriger toute les chaA(r)nes pour aprA"s les utiliser sur votre Wii U. Ceci inclus:
set string204=ChaA(r)ne Infos
set string376=ChaA(r)ne MA(c)tA(c)o
set string377=Messagerie Wii
set string205=ChaA(r)ne Vote
set string206=ChaA(r)ne Nintendo
set string207=ChaA(r)ne Concours Mii
set string256=ChaA(r)ne Concours Mii
set string257=Check Mii Out Channel
set string208=CustomisA(c)
set string209=Tu vas AStre questionnA(c) sur quel chaA(r)ne tu veux corriger.
set string210=Installer RiiConnect24
set string211=Changer de rA(c)gion. RA(c)gion sA(c)lectionnA(c):
set string212= Commencer a corriger ^^!
set string28=Retourner en arriA"re.

set string214=Bonjour / Bonsoir
set string215=Bienvenue dans l'installation express de RiiConnect24.
set string216=Le correctif vas tA(c)lA(c)charger les fichiers requis pour lancer le correctif.
set string217=L'entiA"retA(c) du processus vas prendre entre 1 a 3 minutes, cela dA(c)pends du processeur (de votre ordinateur) et du dA(c)bit de votre connexion internet.
set string218=Avant de continuer, j'ai besoin que vous me disiez quelque chose:
set string219=Pour
set string220=et
set string221=Quel rA(c)gion dois-je tA(c)lA(c)charger et corriger?
set string222=(OA>> vit tu? / RA(c)gion de votre console)
set string223=Choisir-une
set string224=GA(c)nial ^^!
set string225=AprA"s le passage de cette A(c)cran, aucune interaction de votre part sont requis, donc vous pouvez vous relaxer et laissez moi faire le travail ^^!
set string226=Ai-je oubliA(c) quelque chose? Oui ^^! Pour que le correctif soit encore plus facile, je peut tA(c)lA(c)charger tout ce que vous avez besoin et le mettre sur
set string227=votre carte SD ^^!
set string228=S'il vous plait, connectez la Carte SD de votre WiiU sur votre ordinateur.
set string229=ConnectA(c) ^^!
set string230=Je ne peux pas me connecter sur la Carte SD depuis l'ordinateur.
set string231=Ohhh, pas de soucis. Vous pourrez copier les fichiers plus-tard aprA"s le correctif.
set string232=Hmm... apparemment aucune Carte SD n'a A(c)tA(c) trouvA(c) dans votre systA"me. S'il vous plait, Veuillez choisir l'option "Change drive letter"
...
set string235=FA(c)licitations ^^! J'ai correctement dA(c)tectA(c) votre Carte SD ^^! Lettre du disque:
set string236=Je vais pouvoir automatiquement tout tA(c)lA(c)charger et installer sur votre Carte SD ^^!
set string237=Tout est prASt ^^!
set string238=Et maintenant?
set string239=Commencer le correctif
set string111=Sortie
set string241=Changer la lettre du disque
set string242=Encore autre chose ^^! J'ai dA(c)tectA(c) un dossier "WAD".
...
set string249=le problA"me. Le processus du correctif a A(c)tA(c) redA(c)marrA(c).
set string250=Anecdote
set string251=Prochaine anecdote dans
set string252=secondes
set string253=Progression
set string254=TA(c)lA(c)chargement des fichiers
set string258=Finition...

set string259=Et voilA  ^^! Nous sommes ok avec ASSa ^^!
set string260=Copie rA(c)ussie ^^! Tout les fichiers sont sur la Carte SD.
set string261=Quo- quelque chose a foirA(c) ^^! S'il vous plait, copier les dossiers "WAD" et "apps" dans votre Carte SD. Ils sont a cotA(c) de RiiConnect24Patcher.bat
...
set string264=Nous sommes entrain de corriger un fichier qui est responsable du bug de 4:3 (Barres noirs) qui apparaA(r)t dans le mode Wii.
set string265=Maintenant, s'il vous plait connectez la Carte SD vers votre WiiU, aller dans le mode Wii, et ouvrez la ChaA(r)ne Homebrew (Homebrew Launcher).
...
set string277=CrA(c)e par DarkMatterCore.
set string278=Bienvenue
set string279=Ceci est l'A(c)cran de configuration de wad2bin. You will be required to do this step only once.
