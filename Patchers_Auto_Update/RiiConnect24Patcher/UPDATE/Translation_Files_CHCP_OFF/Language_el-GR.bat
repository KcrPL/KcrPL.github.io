...
set string2=Ksekina
set string3=Eukharisties
set string4=Ruthmiseis
set string5=Diakheirisou ton VFF Downloader gia to Dolphin edo
set string6=Trexe ton VFF Downloader mia phora.
set string7=Ekheis kanena problema e thes na epikoinoneseis mazi mas;
set string8=Steile mas mail sto support@riiconnect24.net
set string9=Anikhneuteke karta mnemes SD tou Wii:
set string10=Den mporouse na anikhneutei karta mnemes SD.
set string12=Ananeose
set string12=An einai lathos, mporei na ginei allage argotera.

set string13=Proeidopoiese
set string14=Khresimopoieis mia peiramatike ekdose autou tou programmatos.
set string15=Auto semainei pos aute e ekdose mporei na periekhei peiramatika kharakteristika
set string16=kai sphalmata pou mporei na khalasoun to Wii/Wii U sou e ton upologiste sou.
set string17=An den xereis ti kaneis parakalo pegaine stis ruthmiseis kai pegaine piso ste
set string18=stathere ekdose tou programmatos.

set string19=Plektrologese enan arithmo pou mporeis na deis parapano, dipla apo ten entole kai pata ENTER

set string20=Ergaleia epiluses problematon
set string21=Auta ta ergaleia tha se boethesoun na entopiseis kapoia sphalmata me to programma kai tha prospathesoun na epiluthoun automata.
set string22=Den mporese na anikhneutei karta mnemes SD.
set string23=Den etan dunato na antigraphoun arkheia ste karta mnemes SD.
set string24=Sphalma metonomasias arkheion
set string25=Pegaine piso sto kurios menou
set string26=Epilexe

set string27=Ruthmiseis RiiConnect24 Patcher
set string28=Pegaine piso
set string29=Orise khroma tapetsarias/keimenou
set string30=Energopoiese/apenergopoiese ten enemerose tou Patcher
set string31=Tora
set string33=Allaxe klado anabathmises se
set string33=Peiramatike
set string34=Stathere
set string35=Epidiorthose arkheion programmatos
set string36=Lepse tou Patcher xana
set string37=VFF Downloader gia Ruthmiseis tou Dolphin
set string38=Pleres diagraphe tou VFF Downloader gia to Dolphin apo ton upologiste sou
set string39=Aphairese ton VFF Downloader apo ten ekkinese tou upologiste
set string40=An trekhei o VFF Downloader, kleise ton.
set string41=Parakalo perimene... anaktese dedomenon.
set string42=Theleis na pas piso ste stathere ekdose tou programmatos;
set string43=Ekdose programmatos
set string44=Stathere ekdose
set string45=Suggnome, alla uperxe ena problema sten anaktese dedomenon.
set string46=Theleis na allaxeis klado ekdoses;
set string47=Diadikasia anabathmises tha xekinesei.
set string48=Nai, allaxe ten ekdose tou programmatos se stathere.
set string49=[DEN ETAN EPITUKhES E ALLAGE SE STAThERE EKDOSE]
set string50=Okhi pegaine piso sto kurios menou.
set string51=Theleis na allaxeis ten ekdose tou patcher se peiramatike;
set string 52=Peiramatike ekdose
set string53=Suggnome, den uparkhei peiramatike ekdose aute te stigme.
set string54=Nai, allaxe se peiramatiko klado.
set string55=[DEN ETAN EPITUKhES E ALLAGE SE PEIRAMATIKE EKDOSE]
