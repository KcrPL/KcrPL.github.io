...
set string2=Aloita
set string3=TekijA$?t
set string4=Asetukset
set string5=hallitse VFF Lataaja Dolphinille tA$?A$?llA$?
set string6=Suorita VFF Lataaja kerran.
set string7=Onko ongelmia vai haluatko ottaa yhteyttA$? meihin?
set string8=SA$?hkAPpostita osoitteeseen support@riiconnect24.net
set string9=Tunnistettu Wii SD Kortti:
set string10= Wii SD Korttia ei tunnistettu.
set string11=PA$?ivitA$?
set string12=Jos jokin on vA$?A$?rin, voit muuttaa sen myAPhemmin.

set string13=Varoitus
set string14=KA$?ytA$?t kokeellistaversiota tA$?stA$? ohjelmasta.
set string15=Tarkoittaa sitA$?, ettA$? tA$?mA$? versio sisA$?ltA$?A$? kokeellisiatoimintoja
set string16=ja bugeja, jotka voivat rikkoa sinun Wii/Wii U konsolin tai tietokoneesi.
set string17=Jos et tiedA$? mitA$? teet, mene asetuksiin ja siirry takaisin
set string18=vakaampaan versioon patcherista.

set string19=Kirjoita numero jonka nA$?et yllA$? seuraavan komennon ja paina ENTER

set string20=VianetsintA$? tyAPkalut
set string21=NA$?mA$? tyAPkalut pitA$?isi auttaa sinua diagnisoimaan ongelmia patcherin kanssa ja korjaamaan ne automaattisesti.
set string10=SD Korttia ei tunnistettu.
set string23=Tiedostoja ei voitu kopioida SD Kortille.
set string24=Tiedostojen uudelleennimeA$?minen virhe
set string25=Palaa takaisin pA$?A$?valikkoon
set string26=Valitse

set string27=RiiConnect24 Patcher Asetukset
set string28=Takaisin
set string29=Aseta taustan/tekstin vA$?ri
set string30=Aseta pA$?ivittA$?minen pois/pA$?A$?lle
set string31=TA$?llA$? hetkellA$?
set string32=Vaihda pA$?ivittA$?vA$? haara
set string33=Beeta
set string34=Vakaa
set string35=Korjaa patcher tiedosto
set string36=Uudelleenlataa
set string37=VFF Lataaja Dolphinille Asetukset
set string38=Kokonaan poista VFF Lataaja Dolphinille tietokoneestasi
set string39=Poista VFF Lataaja kA$?ynnistyksestA$?
set string40=Jos VFF lataaja on pA$?A$?llA$?, sammuta se.
set string41=Odota hetki... haetaan dataa.
set string42=Haluatko siirtyA$? takaisin vakaampaan versioon patcherista?
set string43=Nykyinen versio
set string44=Vakaa versio
set string45=Pahoittelut, datan hakemisessa tapahtui virhe.
set string46=Haluatko vaihtaa haarojen vA$?lillA$??
set string47=PA$?ivityksen kA$?sittely alkaa.
set string48=KyllA$?, vaihda vakaaseen haaraan.
set string49=[EI VOITU VAIHTAA VAKAAMPAAN VERSIOON]
set string50=Ei, mene takaisin pA$?A$?valikkoon.
set string51=Haluatko siirtyA$? BEETA versioon patcherista?
set string52=Beeta versio
set string53=Pahoittelut, julkista beeta versiota ei ole tA$?llA$? hetkellA$? saatavilla.
set string54=KyllA$?, vaihda Beeta haaraan.
set string55=[EI VOITU SIIRTYA,, BEETA VERSIOON]

set string56=ODOTA
set string57=YritA$?tkAP kytkeA$? pois pA$?A$?ltA$? pA$?ivittA$?misen?
set string58=Muista ettA$? pA$?ivitykset pitA$?vA$?t sinut turvassa ja pA$?ivitettynA$? patcherissa.
set string59=KA$?ytA$? tA$?tA$? vaihtoehtoa vain debuggaamiseen ja vianetsintA$?A$?n.
set string60=Oletko varma, ettA$? haluat kytkeA$? pois pA$?A$?ltA$? automaattisetpA$?ivitykset?

set string61=KyllA$?
set string62=Ei, mene takaisin.

set string63=Vaihda vA$?ri:
set string64=Tumma teema
set string65=Vaalea teema *A,,lA$? satuta minun silmiA$?ni*
set string66=Vaalea teema *KyllA$? satuta minun silmA$?t*
set string67=Keltainen
set string68=VihreA$?
set string69=Punainen
set string70=Sininen

set string71=Ladataan curl... Ole hyvA$? ja odota.
set string72=TA$?mA$? voi kestA$?A$? jonkinaikaa...

set string73=VIRHE.
set string74=Esiintyi virhe ladattaessa curl.
set string75=Avaamme nyt sivun, joka lataa curl.exe.
set string76=SiirrA$? curl.exe RiiConnect24 Patcherin kansioon ja kA$?ynnistA$? patcher uudelleen.
set string77=Paina mitA$? tahansa nA$?ppA$?intA$? avataaksesi lataus sivun selainmessa ja palaa pA$?A$?valikkoon.

set string78=Tarkistetaan pA$?ivityksiA$?...
set string79=PA$?ivitys on saatavilla.
set string80=PA$?ivitys tA$?lle ohjelmalle on saatavilla. Suosittelemme lataamaan RiiConnect24 Patcherin viimeisinpA$?A$?n versioon.
set string81=Nykyinen versio
set string82=Uusi versio
set string83=PA$?ivitA$?
set string84=HylkA$?A$?
set string85=MitA$? uutta on tA$?ssA$? pA$?ivityksessA$??
set string86=PA$?ivitetA$?A$?n.
set string87=Odota hetki...
set string88=RiiConnect24 Patcher kA$?ynnistyy pian uudelleen...
set string74=Esiintyi virhe ladattaessa pA$?ivitys avustajaa.
set string90=Paina mitA$? tahansa nA$?ppA$?intA$? palataaksesi pA$?A$?valikkoon.
set string91=MitA$? uutta on pA$?ivityksessA$?
set string92=Virhe. MitA$? uutta tiedosto ei ole saatavilla.
set string93=Paina mitA$? tahansa nA$?ppA$?intA$? palataaksesi takaisin.
:: Local end

:: Must be available online
set string100=Tervetuloa Homebrew Kauppaan.
set string101=Ennen kun lataat homebrewiA$?, haluatko kytkeA$? pA$?A$?lle automaattisen asennuksen SD Kortille?
set string102=KyllA$?, tunnista SD Kortti.
set string103=Ei, asennan ne manuaalisesti.
set string104=Hmm... nA$?yttA$?A$? siltA$? ettA$? SD Korttia ei lAPytynyt tietokoneeltasi. Valitse `Vaihda aseman kirjain` valinta
set string105=Asettaaksesi SD Kortti aseman kirjaimen manuaalisesti.
set string106=Muuten sinun tA$?ytyy kopioida homebrewit SD Kortille manuaalisesti.
set string107=Onnittelut^^! Olen onnistuneesti tunnistanut SD Korttisi^^! Aseman kirjain:
set string108=Pystyn automaattisesti lataamaan ja asentamaan kaiken sinun SD Kortille^^!
set string109=MitA$? seuraavaksi?
set string110=Jatka
set string111=Poistu
set string112=Vaihda aseman kirjain
set string113=Nykyisen SD Kortin kirjain
set string114=Kirjoita uuden aseman kirjain (esim. H)
set string115=Valmistellaan Open Shop Kanava lataajan kA$?yttAPA$?...
set string116=Odota hetki...
set string117=Esiintyi virhe ladattaessa Open Shop kanavan lataajaa.
set string118=CURL Virhe Koodi
set string119=Paina mitA$? tahansa nA$?ppA$?intA$? mennA$?ksesi takaisin.
set string120=Open Shop Kanavan Lataaja on valmis^^! MitA$? seuraavaksi?
set string121=NA$?ytA$? lista mitA$? homebrewiA$? on saatavilla.
set string122=Lataa homebrewiA$?.
set string123=Palaa pA$?A$?valikkoon
set string124=Yksi hetki odota...
set string125=VIHJE: Muista homebrew sovelluksen nimi johon olet kiinnostunut, palaa ohjelmaan, valitse "Lataa homebrewiA$?" ja kirjoita se.
set string126=Se nA$?yttA$?A$? sinulle kuvauksen ja muuta hyAPdyllistA$? tietoa homebrewistA$?, jonka olet valinnut.
set string127=Lista HomebrewiA$? saatavilla
set string128=Kirjoita homebrewin nimi.
set string129=ei ole servereillA$? saatavilla.
set string130=Jos haluat nA$?hdA$? listan homebrewejA$?, jotka ovat servereillA$? palaa takaisin ja valitse "NA$?ytA$? lista homebrewiA$? saatavilla".
set string131=Haetaan dataa...
set string132=Olet pyytA$?nyt...
set string133=PitkA$? kuvaus:
set string134=Haluatko ladata tA$?mA$?n sovelluksen?
set string135=Jos on kytketty pA$?A$?lle, se asentuu SD Kortillesi automaattisesti.
set string136=Ei, palaa.
set string137=Ladataan
set string138=Ladataan .ZIP
set string139=Valmis^^!
set string140=.ZIP tiedosto on RiiConnect24 Patcherin kansiossa.
set string119=Paina mitA$? tahansa nA$?ppA$?intA$? palataaksesi takaisin.
set string142=Ladataan 7zip CLI
set string143=Puretaan homebrew sovellus SD Kortillesi...
set string144=Esiintyi virhe ladatessa homebrewiA$?si.
set string145=Esiintyi virhe ladatessa homebrewiA$? Open Shop Kanavan serveriltA$?.
set string146=Esiintyi virhe ladatessa 7zip.
set string147=Esiintyi virhe kopioidessa tiedostoja SD Kortillesi.

::
set string148=Ilmoitus
set string149=Tervetuloa RiiConnect24 Patcheriin^^!
set string150=TA$?llA$? ohjelmalla voit patchata sinun Wii tai Wii U konsolin kA$?yttA$?A$?ksesi RiiConnect24 palvelua.
set string151=Voit myAPs kA$?yttA$?A$? muita tyAPkaluja kuten Wiimmfi Patcher pelataaksesi Wii pelejA$? taas netissA$?.
set string152=Joten, mitA$? laitetta patchaamme tA$?nA$?A$?n?
set string153=Dolphin Emulaattori
set string154=Valitse fiksusti

set string155=MitA$? moodia minun pitA$?isi suorittaa
...
set string275=TA$?mA$? auttaa sinua poistamaan RiiConnect24 sinun Wii konsolista.
set string157=TA$?mA$? patcher opastaa sinut prosessin lA$?pi asentamaan RiiConnect24
set string158=Muut tyAPkalut
