...
set string5=hallitse VFF Lataaja Dolphinille taalla
set string6=Suorita VFF Lataaja kerran.
set string7=Onko ongelmia vai haluatko ottaa yhteytta meihin?
set string8=Sahkopostita osoitteeseen support@riiconnect24.net
set string9=Tunnistettu Wii SD Kortti:
set string10= Wii SD Korttia ei tunnistettu.
set string11=Paivita
set string12=Jos jokin on vaarin, voit muuttaa sen myohemmin.

set string13=Varoitus
set string14=Kaytat kokeellistaversiota tasta ohjelmasta.
set string15=Tarkoittaa sita, etta tama versio sisaltaa kokeellisiatoimintoja
...
set string19=Kirjoita numero jonka naet ylla seuraavan komennon ja paina ENTER

set string20=Vianetsinta tyokalut
set string21=Nama tyokalut pitaisi auttaa sinua diagnisoimaan ongelmia patcherin kanssa ja korjaamaan ne automaattisesti.
set string10=SD Korttia ei tunnistettu.
set string23=Tiedostoja ei voitu kopioida SD Kortille.
set string24=Tiedostojen uudelleennimeaminen virhe
set string25=Palaa takaisin paavalikkoon
set string26=Valitse

set string27=RiiConnect24 Patcher Asetukset
set string28=Takaisin
set string29=Aseta taustan/tekstin vari
set string30=Aseta paivittaminen pois/paalle
set string31=Talla hetkella
set string32=Vaihda paivittava haara
set string33=Beeta
set string34=Vakaa
...
set string39=Poista VFF Lataaja kaynnistyksesta
set string40=Jos VFF lataaja on paalla, sammuta se.
...
set string46=Haluatko vaihtaa haarojen valilla?
set string47=Paivityksen kasittely alkaa.
set string48=Kylla, vaihda vakaaseen haaraan.
set string49=[EI VOITU VAIHTAA VAKAAMPAAN VERSIOON]
set string50=Ei, mene takaisin paavalikkoon.
set string51=Haluatko siirtya BEETA versioon patcherista?
set string52=Beeta versio
set string53=Pahoittelut, julkista beeta versiota ei ole talla hetkella saatavilla.
set string54=Kylla, vaihda Beeta haaraan.
set string55=[EI VOITU SIIRTYA BEETA VERSIOON]

set string56=ODOTA
set string57=Yritatko kytkea pois paalta paivittamisen?
set string58=Muista etta paivitykset pitavat sinut turvassa ja paivitettyna patcherissa.
set string59=Kayta tata vaihtoehtoa vain debuggaamiseen ja vianetsintaan.
set string60=Oletko varma, etta haluat kytkea pois paalta automaattisetpaivitykset?

set string61=Kylla
set string62=Ei, mene takaisin.

set string63=Vaihda vari:
set string64=Tumma teema
set string65=Vaalea teema *Ala satuta minun silmiani*
set string66=Vaalea teema *Kylla satuta minun silmat*
...
set string72=Tama voi kestaa jonkinaikaa...

set string73=VIRHE.
set string74=Esiintyi virhe ladattaessa curl.
set string75=Avaamme nyt sivun, joka lataa curl.exe.
set string76=Siirra curl.exe RiiConnect24 Patcherin kansioon ja kaynnista patcher uudelleen.
set string77=Paina mita tahansa nappainta avataaksesi lataus sivun selainmessa ja palaa paavalikkoon.

set string78=Tarkistetaan paivityksia...
set string79=Paivitys on saatavilla.
set string80=Paivitys talle ohjelmalle on saatavilla. Suosittelemme lataamaan RiiConnect24 Patcherin viimeisinpaan versioon.
set string81=Nykyinen versio
set string82=Uusi versio
set string83=Paivita
set string84=Hylkaa
set string85=Mita uutta on tassa paivityksessa?
set string86=Paivitetaan.
set string87=Odota hetki...
set string88=RiiConnect24 Patcher kaynnistyy pian uudelleen...
set string74=Esiintyi virhe ladattaessa paivitys avustajaa.
set string90=Paina mita tahansa nappainta palataaksesi paavalikkoon.
set string91=Mita uutta on paivityksessa
set string92=Virhe. Mita uutta tiedosto ei ole saatavilla.
set string93=Paina mita tahansa nappainta palataaksesi takaisin.
:: Local end

:: Must be available online
set string100=Tervetuloa Homebrew Kauppaan.
set string101=Ennen kun lataat homebrewia, haluatko kytkea paalle automaattisen asennuksen SD Kortille?
set string102=Kylla, tunnista SD Kortti.
set string103=Ei, asennan ne manuaalisesti.
set string104=Hmm... nayttaa silta etta SD Korttia ei loytynyt tietokoneeltasi. Valitse `Vaihda aseman kirjain` valinta
set string105=Asettaaksesi SD Kortti aseman kirjaimen manuaalisesti.
set string106=Muuten sinun taytyy kopioida homebrewit SD Kortille manuaalisesti.
set string107=Congrats^! I've successfully detected your SD Card^! Aseman kirjain:
...
set string115=Valmistellaan Open Shop Kanava lataajan kayttoa...
...
set string119=Paina mita tahansa nappainta mennaksesi takaisin.
set string120=Open Shop Channel Downloader is ready^! Mita seuraavaksi?
set string121=Nayta lista mita homebrewia on saatavilla.
set string122=Lataa homebrewia.
set string123=Palaa paavalikkoon
...
set string126=Se nayttaa sinulle kuvauksen ja muuta hyodyllista tietoa homebrewista, jonka olet valinnut.
...
set string130=Jos haluat nahda listan homebreweja, jotka ovat servereilla palaa takaisin ja valitse "Nayta lista homebrewia saatavilla".
set string131=Haetaan dataa...
set string132=Olet pyytanyt...
set string133=Pitka kuvaus:
set string134=Haluatko ladata taman sovelluksen?
set string135=Jos on kytketty paalle, se asentuu SD Kortillesi automaattisesti.
...
set string119=Paina mita tahansa nappainta palataaksesi takaisin.
set string142=Ladataan 7zip CLI
set string143=Puretaan homebrew sovellus SD Kortillesi...
set string144=Esiintyi virhe ladatessa homebrewiasi.
...
set string150=Talla ohjelmalla voit patchata sinun Wii tai Wii U konsolin kayttaaksesi RiiConnect24 palvelua.
set string151=Voit myos kayttaa muita tyokaluja kuten Wiimmfi Patcher pelataaksesi Wii peleja taas netissa.
set string152=Joten, mita laitetta patchaamme tanaan?
set string153=Dolphin Emulaattori
set string154=Valitse fiksusti

set string155=Mita moodia minun pitaisi suorittaa
...
set string275=Tama auttaa sinua poistamaan RiiConnect24 sinun Wii konsolista.
set string157=Tama patcher opastaa sinut prosessin lapi asentamaan RiiConnect24
set string158=Muut tyokalut
...
set string232=Hmm... nayttaa silta etta SD Korttia ei loytynyt tietokoneeltasi. Valitse `Vaihda aseman kirjain` valinta
...
set string235=Congrats^! I've successfully detected your SD Card^! Aseman kirjain:
