...
set string16=Das bedeutet, dass diese Version moglicherweise experimentelle Funktionen enthalt
...
set string38=Loschen Sie den VFF Downloader fur Dolphin vollstandig von Ihrem Computer
set string39=Loschen Sie den VFF Downloader vom Start
...
set string105=Hmm.. Es sieht so aus, als ob in Ihrem System keine SD-Karte gefunden wurde. Bitte wahlen Sie die Option "Laufwerksbuchstaben andern"
...
set string126=TIPP: Merken Sie sich den Namen des Homebrew, an dem Sie interessiert sind, kehren Sie zum Programm zuruck, wahlen Sie "Homebrew herunterladen" und geben Sie es ein.
...
set string130=Fur die Liste der Homebrews, die sich auf dem Server befinden, gehen Sie bitte zuruck und wahlen Sie "Liste der verfugbaren Homebrews anzeigen".
...
set string280=Since every Wii is different, you will be required to dump keys from your Wii. Es klingt beangstigend, aber keine Sorge, weil wir
...
set string475=Vielen Dank fur das Verwenden dieses Patchers ^^! :)
