...
set string23=Kan geen bestanden kopieren naar de SD-kaart.
...
set string106=Anders moet je je handmatig de homebrew kopieren naar de SD Kaart.
...
set string416=Ga naar Wii Opties.
set string417=Ga naar Wii Instellingen.
set string418=Ga naar Pagina 2, klik dan op Internet.
