...
set string10=NALo foi possAvel detetar o teu cartALo SD do Wii.
set string11=Recarregar
set string12=Se estiver incorreto, podes mudar depois.

set string13=Aviso
set string14=EstAVs a usar uma versALo experimental deste programa.
set string15=Isso significa que esta versALo pode conter funASSAues experimentais
set string16=e bugs que podem danificar a consola Wii/Wii U ou o computador.
set string17=Se nALo sabes o que estAV a fazer, por favor dirige-te A s definiASSAues e volta a
set string18=uma versALo estAVvel do patcher.

set string19=Digita um nAsmero que podes ver acima ao lado do comando e pressiona ENTER

set string20=Ferramentas de resoluASSALo de problemas
set string21=Estas ferramentas devem ajudar a diagnosticar alguns problemas com o patcher e ajudar a reparAV-los automaticamente.
set string22=NALo foi possAvel detetar o cartALo SD.
set string23=NALo foi possAvel copiar ficheiros para o cartALo SD.
set string24=Erro ao renomear arquivos
set string25=Retornar ao menu principal
set string26=Escolhe

set string27=DefiniASSAues do Patcher RiiConnect24
set string28=Volta para trAVs
set string29=Definir cor de fundo e cor do texto
set string30=Ligar/Desligar atualizaASSAues
set string31=Atualmente
set string32=Mudar ramo de atualizaASSAues para
set string33=Beta
set string34=EstAVvel
set string35=Reparar ficheiro do patcher
set string36=Descarregar de novo
set string37=DefiniASSAues do VFF Downloader for Dolphin
set string38=Apagar VFF Downloader for Dolphin completamente do seu computador
set string39=Deletar VFF Downloader do arranque
set string40=Se VFF Downloader estiver em execuASSALo, desligAV-lo.
set string41=Por favor aguarde... Obtendo dados...
set string42=Queres voltar A  versALo estAVvel do patcher?
...
set string47=O processo de atualizaASSALo irAV comeASSar.
set string48=Sim, muda para um branch estAVvel.
set string49=[NAO FOI POSSATVEL MUDAR PARA UMA VERSAO ESTAVEL]
set string50=NALo, volta para o menu principal.
set string51=Queres mudar para uma versALo BETA do patcher?
set string52=VersALo Beta
set string53=Desculpa, nALo existe uma versALo beta publica disponAvel neste momento.
set string54=Sim, muda para um branch Beta.
set string55=[NAO FOI POSSATVEL MUDAR PARA UMA VERSAO BETA]

set string56=ESPERA
set string57=EstAVs a tentar desativar as atualizaASSAues?
set string58=Por favor, lembra-te que essas atualizaASSAues mantASm-te seguro e atualizado sobre o patcher.
set string59=Utiliza esta opASSALo sAl para depuraASSALo e resoluASSALo de problemas.
set string60=Tens a certeza que queres desativar as atualizaASSAues automAVticas?

set string61=Sim
set string62=NALo, volta para trAVs.

set string63=Mudar a cor:
set string64=Tema Escuro
set string65=Tema Claro *EdiASSALo: Por favor nALo me magoes os olhos*
set string66=Tema Claro *EdiASSALo: aniquila os meus olhos*
...
set string73=ERRO.
set string74=Ocorreu um erro durante a transferASncia do curl.
...
set string276=Instalar ficheiros WAD diretamente no CartALo SD - wad2bin.
...
set string443=Sabias que as letras no nAsmero do modelo do Wii [RVL] representam o nome de cAldigo da Wii, Revolution?
...
set string446=A%0 possAvel usar velas como uma Barra de Sensor para a Wii.
...
set string449=Sabias que a grande maioria dos scripts usados para o funcionamento do RiiConnect24 sALo escritos em Python?
...
set string472=Cada ficheiro estAV no lugar certo no seu CartALo SD^^!
set string473=VocAS pode encontrar essas pastas ao lado do RiiConnect24Patcher.bat.
set string474=Por favor proceda com o tutorial que se encontra neste website: https://wii.guide/riiconnect24

set string475=Muito obrigado por usar o nosso patcher^^! :^)
set string476=Diverte-te a usar o RiiConnect24^^!
set string477=A fechar o patcher em:

set string478 = NALo hAV conexALo com a Internet.
set string479=NALo foi possAvel conectar ao servidor.
set string480=Verifique a sua conexALo de Internet ou verifique que o seu firewall nALo estAV a bloquear o curl.
set string481=Ocorreu um erro durante o processo de patch.
set string482=CAldigo de Erro
set string483=MAldulo a falhar
set string484=DICA: Tenta desligar o seu antivirus temporariamente.
set string485=SOLUA++AO: Verifique a sua conexALo de Internet.
...
set string487=SOLUA++AO: Por favor instala a versALo mais recente do .NET Framework e tenta outra vez.
