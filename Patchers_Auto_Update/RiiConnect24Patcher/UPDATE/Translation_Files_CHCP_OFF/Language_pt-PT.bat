...
set string17=Se nao sabes o que esta a fazer, por favor dirige-te as definicoes e volta a
...
set string40=Se VFF Downloader estiver em execucao, desliga-lo.
...
set string472=Cada ficheiro esta no lugar certo no seu Cartao SD^^!
