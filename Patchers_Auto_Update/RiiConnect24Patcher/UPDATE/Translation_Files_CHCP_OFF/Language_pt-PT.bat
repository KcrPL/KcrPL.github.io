...
set string4=Definicoes
set string5=gere o VFF Downloader for Dolphin aqui
set string6=Executar o VFF Downloader apenas uma vez.
set string7=Tens algum problema ou queres nos contactar?
set string8=Envia-nos mail em support@riiconnect24.net
set string9=Wii SD Card detetado:
set string10=Nao foi possivel detetar o teu cartao SD do Wii.
set string11=Recarregar
set string12=Se estiver incorreto, podes mudar depois.

set string13=Aviso
set string14=Estas a usar uma versao experimental deste programa.
set string15=Isso significa que esta versao pode conter funcoes experimentais
set string16=e bugs que podem danificar a consola Wii/Wii U ou o computador.
set string17=Se nao sabes o que estas a fazer, por favor dirige-te as definicoes e volta a
set string18=uma versao estavel do patcher.

set string19=Digita um numero que podes ver acima ao lado do comando e pressiona ENTER

set string20=Ferramentas de resolucao de problemas
set string21=Estas ferramentas devem ajudar a diagnosticar alguns problemas com o patcher e ajudar a repara-los automaticamente.
set string22=Nao foi possivel detetar o cartao SD.
set string23=Nao foi possivel copiar ficheiros para o cartao SD.
set string24=Erro ao renomear os arquivos
set string25= Regressar ao menu principal
set string26=Escolhe

set string27=Definicoes do Patcher RiiConnect24
set string28=Volta para tras
set string29=Definir cor de fundo e cor do texto
set string30=Ligar/Desligar atualizacoes
set string31=Atualmente
set string32=Mudar ramo de atualizacoes para
set string33=Beta
set string34=Estavel
set string35=Reparar ficheiro do patcher
set string36=Descarregar de novo
set string37=Definicoes do VFF Downloader for Dolphin
set string38=Apagar VFF Downloader para o Dolphin completamente do teu computador
set string39=Apagar o VFF Downloader do arranque
set string40=Se o VFF Downloader estiver em execucao, desliga-lo.
set string41=Por favor aguarde... A obter dados.
set string42=Queres voltar a versao estavel do patcher?
set string43=Versao atual
set string44=Versao estavel
set string45=Desculpa, houve um erro durante a procura de dados.
set string46=Queres mudar de branches?
set string47=O processo de atualizacao ira comecar.
set string48=Sim, muda para um branch estavel.
set string49=[NAO FOI POSSIVEL MUDAR PARA UMA VERSAO ESTAVEL]
set string50=Nao, volta para o menu principal.
set string51=Queres mudar para uma versao BETA do patcher?
set string52=Versao Beta
set string53=Desculpa, nao existe uma versao beta publica disponivel neste momento.
set string54=Sim, muda para um branch Beta.
set string55=[NAO FOI POSSIVEL MUDAR PARA UMA VERSAO BETA]

set string56=ESPERA
set string57=Estas a tentar desativar as atualizacoes?
set string58=Por favor, lembra-te que essas atualizacoes mantem-te seguro e atualizado sobre o patcher.
set string59=Utiliza esta opcao so para depuracao e resolucao de problemas.
set string60=Tens a certeza que queres desativar as atualizacoes automaticas?

set string61=Sim
set string62=Nao, volta para tras.

set string63=Mudar a cor:
set string64=Tema Escuro
set string65=Tema Claro *Edicao: Por favor nao me magoes os olhos*
set string66=Tema Claro *Edicao: aniquila os meus olhos*
...
set string73=ERRO.
set string74=Ocorreu um erro durante a transferencia do curl.
set string75=Vamos abrir um website para transferir o curl.exe.
set string76=Por favor move o curl.exe para a pasta onde o patcher do RiiConnect24 esta e reinicia o patcher.
set string77=Clica em qualquer tecla para abrires uma pagina de download num browser e para regressares ao menu.

set string78=A procurar atualizacoes...
set string79=Uma atualizacao esta disponivel.
set string80=Uma atualizacao para este programa esta disponivel. Recomendamos atualizares o patcher do RiiConnect24 para a sua ultima versao.
set string81=Versao atual
set string82=Versao nova
set string83=Atualizar
set string84=Dispensar
set string85=O que ha de novo nesta atualizacao?
set string86=A atualizar.
set string87=Por favor aguarda...
set string88=O patcher do RiiConnect24 vai reiniciar brevemente...
set string89=Houve um erro ao transferir o assistente de atualizacao.
set string90= Clica em qualquer tecla para regressares ao menu principal.
set string91= O que ha de novo na atualizacao
set string92=Erro. O ficheiro "O que ha de novo" nao esta disponivel.
...
set string276=Instalar ficheiros WAD diretamente no Cartao SD - wad2bin.
...
set string443=Sabias que as letras no numero do modelo do Wii [RVL] representam o nome de codigo da Wii, Revolution?
...
set string445=O Internet Channel antes costava 500 Wii Points.
set string446=E possivel usar velas como uma Barra de Sensor para a Wii.
...
set string449=Sabias que a grande maioria dos scripts usados para o funcionamento do RiiConnect24 sao escritos em Python?
...
set string473=Voce pode encontrar essas pastas ao lado do RiiConnect24Patcher.bat.
set string474=Por favor proceda com o tutorial que se encontra neste website: https://wii.guide/riiconnect24

set string475=Thank you very much for using this patcher^! :^)
set string476=Have fun using RiiConnect24^!
set string477=A fechar o patcher em:

set string478 = Nao ha conexao com a Internet.
set string479=Nao foi possivel conectar ao servidor.
set string480=Verifique a sua conexao de Internet ou verifique que o seu firewall nao esta a bloquear o curl.
set string481=Ocorreu um erro durante o processo de patch.
set string482=Codigo de Erro
set string483=Modulo a falhar
set string484=DICA: Tenta desligar o seu antivirus temporariamente.
set string485=SOLUCAO: Verifique a sua conexao de Internet.
set string486=DETALHES DO ERRO: Erro de escrita do curl. Tenta mover o patcher para o ambiente de trabalho e tenta outra vez.
set string487=SOLUCAO: Por favor instala a versao mais recente do .NET Framework e tenta outra vez.
