...
set string3=Itibar
set string4=Ayarlar
set string5=Dolphin icin VFF Indirici'yi burada yonet
set string6=Bir kere VFF Indirici'yi baslat.
set string7=Sorunlariniz mi var veya bizimle iletisime gecmek mi istiyorsunuz?
set string8=support@riiconnect24.net adresinden bize e-posta gonderin
set string9=Wii SD Karti Algilandi:
set string10=Malesef Wii SD Karti algilanamadi.
set string11=Yenile
set string12=Yanlissa, daha sonra degistirebilirsin.

set string13=Uyari
set string14=Bu programin deneysel bir surumunu kullaniyorsunuz.
set string15=Bu demek bu surum deneysel ozellikler
set string16=ve belki sizin Wii/Wii U konsolunuzu veya bilgisayarinizi bozabilecek yazilim hatalari icerebilir.
set string17=Eger ne yaptigini bilmiyorsan, lutfen ayarlara git ve
set string18=yamalayici'nin sabit versiyonuna don.

set string19=Yukaridaki komutun yaninda gorebileceginiz bir sayi yazin ve ENTER tusuna basin

set string20=Sorun Giderme Araclari
set string21=Bu araclar, yamalayiciyla ilgili bazi sorunlari teshis etmenize yardimci olup onlari otomatik olarak onarmaya calisacaktir.
set string22=Wii SD Karti algilanamadi.
set string23=Dosyalar SD Karta kopyalanamadi.
set string24=Dosya ad degistirme hatasi
set string25=Ana menuye don
set string26=Sec

set string27=RiiConnect24 Yamalayici Ayarlari
set string28=Geri don
...
cURL Cikis Kodu
geri donmek icin herhangi bir dugmeye basin.
set string120=Open Shop Channel Downloader is ready^! Siradaki ne?
...
set string232=Hmm... sisteminizde bir SD Kart bulunamadi gibi gorunuyor. Lutfen "Surucu harfini degistir" secenegini secin
...
set string235=Congrats^! I've successfully detected your SD Card^! Surucu harfi:
