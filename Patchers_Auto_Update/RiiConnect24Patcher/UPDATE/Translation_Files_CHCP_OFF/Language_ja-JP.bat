...
set string1=c,'c-aa(r)Wiia,'RiiConnecta(tm)a,<aEUR,
set string2=aZaa,a,<
set string3=a,Za!a,,aa
set string4=c"l(r)s
set string5=a"aVa,%0a<<VFF Downloader for Dolphina,'c(r)Vc+a(tm)a,<
set string6=VFF Downloadera,'dL'l>zl(r)zcVSa(tm)a,<
set string7=Do you have problems or want to contact us?
set string8=aVaLa<<aZsupport@riiconnect24.netaSSa(tm)aEUR,
set string9=Wii SDa,<<aLa%0aSc$?sl++sa*a,Sala--azdLs
set string10=c,'c-aa(r)Wii SDa,<<aLa%0a,'c$?sl++saSSaTala>a,"aEUR,
set string11=aSa*a!aa,*aA
set string12=If incorrect, you can change later.

set string13=a"cl"c,,Z
...
set string20=aa(c)a-a<<a,*aAaLa+a,Lala,dega>>a,,aLa<<
set string21=These tools should help you diagnose some problems with the patcher and try to repair them automatically.
set string22=SDa,<<aLa%0a,'c$?sl++saSSaTala>a,"aEUR,
set string23=Could not copy files to the SD Card.
set string24=a*a,Va,$?a<<a,'lTl%0Tl$?%0c>'a(tm)a,<a,"a(c)aLaSc(tm)sc"za--ala--az
set string25=aVa,$?alaVa<aAaLa,
set string26=c+-sl(r)s

set string27=RiiConnect 24 Patchera(r)c"l(r)s
set string28=c>>a,<
...
set string33=a(tm)aLa,zc%0
set string34=l(r)%0l(r)sc%0
...
set string41=ll...aLa|a,<a*a,,a>>a>>a>> fetching data.
set string42=Do you want to go back to stable version of the patcher?
set string43=csEURc-dega(r)aaLa,,aSSal
set string44=l(r)%0l(r)sc%0
...
set string61=aZa,,
set string62=a,,a,,aaEURc>>a,SaEUR,

set string63=c%0,a,'l$?%0aa,<dLs
set string64=cs--a,,a+aLaz
set string65=cZa,<a,,a+aLaz
set string66=c(tm)"a+aLaz
set string67=e>>,,c%0,
set string68=c*'
set string69=cu$?
set string70=et'

set string71=curla,'aEURa,|alaaLa%0a,aSSa(tm)aEUR, ll...aLa|a,<a*a,,aEUR,
set string72=c(tm),e-"aSa<a<a,<l 'laSa,a,Sala(tm)a>>a>>a>>

set string73=a,"a(c)aLaSc(tm)sc"za--ala--azaEUR,
...
set string116=ll...aLa|a,<a*a,,a>>a>>a>>
...
set string123=aVa,$?alaVa<aAaLa,
set string124=aVa,++aLa"ll...aLa|a,<a*a,,a>>a>>a>>
...
set string131=a++aLa,za,'lZ--azVa--a|a,,ala(tm)a>>a>>a>>
...
set string137=aEURa,|alaaLa%0a,
set string138=Downloading .ZIP
set string139=l(r)Sas+^ ^dL
...
::
set string148=c(tm)scV"
set string149=RiiConnect24 Patchera,a,a+a"at^ ^dL
...
set string204=a<aAaLa,aaaLalaTa<<
set string376=aSl$?(c)cdeg--aaLalaTa<<
set string377=WiiaVaa,>>aLa,,
set string205=aza,"aSaSScS*cA"aaLalaTa<<
set string206=aza,"aSa(r)a<ala+ala%0aLaaLalaTa<<
set string207=Miia,lala+a,aaaaLalaTa<<
set string256=Miia,lala+a,aaaaLalaTa<<
set string257=Miia,lala+a,aaaaLalaTa<<
set string208=Custom
set string209=You will be asked what you want to patch.
set string210=RiiConnect24a,'a,$?ala,aaaLa<<a(tm)a,<
...
set string243=l%0Se(tm)$?a(tm)a,<lz...c|aSa,a,Sala(tm)aEUR,
set string244=aSSaTala(tm)a<dLz
set string245=aZa,,
set string246=a,,a,,a
...
set string329=a,,a,,aaEURc>>a,SaEUR,
a*a,Va,$?a<<a,'a,$?ala,aaaLa<<a,
set string331=out of
set string332=a*a,Va,$?a<<a(r)lTl%0T
set string333=a,$?ala,aaaLa<<l(r)Sas+dL 
...
set string351=ISOa*a,Va,$?a<<
set string352=WBFSa*a,Va,$?a<<
set string353=Found
