...
set string4=She Ding 
set string5=kochiraniVFF Downloader for DolphinwoGuan Li suru
set string6=VFF Downloaderwo1Hui Shi Xing suru
set string7=He kaWen Ti gaatsutari, Lian Luo shitaikotogaarimasuka?
set string8=meruhasupport@riiconnect24.netdesu. 
set string9=Wii SDkadogaJian Chu saremashita:
set string10=Gui Fang noWii SDkadowoJian Chu dekimasen. 
set string11=rihuretsushiyu
set string12=Jian Wei tsutaChang He ha, Hou deBian Geng dekimasu

set string13=goZhu Yi 
set string14=konopuroguramuhaShi Yan De nabaziyondesu
set string15=tsumari, konobaziyonnihaShi Yan De naJi Neng gaHan mareteimasu
set string16=yotsute, Wii/Wii U konsoruyaanatanokonpiyutawoPo Huai suruKe Neng Xing gaarimasu
set string17=moshiZi Fen gaHe woshiteirunokawakaranainonara, She Ding niLi tsutekudasai
set string18=PatchernoAn Ding shitaburanchi

set string19=Shang Ji nokomandonoHeng niBiao Shi sareteiruShu Zi woRu Li shi, EnterkiwoYa shitekudasai

set string20=toraburushiyuteingutsuru
set string21=koreranotsuruha, PatchernoikutsukanoWen Ti woZhen Duan shi, Zi Dong De niXiu Fu surunoniYi Li chimasu
set string22=SDkadowoJian Chu dekimasen. 
set string23=SDkadonihuairuwokopidekimasendeshita. 
set string24=huairuwoMing Qian Bian Geng surueragaFa Sheng shimashita
set string25=meinmeniyuhe
set string26=Jue Ding 

set string27=RiiConnect 24 PatchernoShe Ding 
set string28=Li ru
set string29=Bei Jing Se toWen Zi Se woShe Ding suru
set string30=atsupudetonoonohu
set string31=Xian Zai 
set string32=Geng Xin buranchiwoBian Geng 
set string33=betaBan 
set string34=An Ding Ban 
set string35=PatcherwoXiu Fu 
set string36=Zai daunrodo
set string37=VFF Downloader for DolphinShe Ding 
set string38=Completely delete VFF Downloader for Dolphin from your computer
set string39=sutatoatsupukara VFF Downloader woXue Chu suru
set string40=If VFF Downloader is running, shut it down.
set string41=Dai tsuteXia sai fetching data.
set string42=patchernoAn Ding Ban niLi shimasuka?
set string43=Zui Xin nobaziyon
set string44=An Ding Ban 
set string45=detanoQu De Zhong nieragaFa Sheng shimashita
set string46=buranchiwoBian Geng shimasuka?
set string47=atsupudetogaKai Shi saremasu
set string48=hai, An Ding shitaburanchiniBian Geng shimasu
set string49=[An Ding Ban niQie riTi erukotogadekimasen]
set string50=iie, meinmeniyuniLi rimasu
set string51=patherwobetaBan niBian Geng shimasuka?
set string52=betaBan 
...
set string61=hai
set string62=iie, Li re. 

set string63=Se woBian eru:
set string64=An itema
set string65=Ming ruitema
set string66=Bai tema
set string67=Huang Se 
set string68=Lu 
set string69=Chi 
set string70=Qing 

set string71=curlwodaunrodoZhong desu.  Dai tsuteXia sai. 
set string72=Shi Jian gakakaruChang He gaarimasu

set string73=eragaFa Sheng shimashita. 
...
set string82=Xin shiibaziyon
set string83=Geng Xin suru
set string84=Dismiss
set string85=What's new in this update?
set string86=Geng Xin Zhong . 
set string87=Dai tsuteXia sai
set string88=RiiConnect24 PatchergaZai Qi Dong sareru
...
set string93=He kakiwoYa shiteLi ru
:: Local end
...
set string 110=Sok keru
set string111=Zhong Liao 
...
set string116=Dai tsuteXia sai
...
set string122=Homebrewwodaunrodosuru
set string123=meinmeniyuhe
set string124=chiyotsutoDai tsuteXia sai
...
set string131=detawoShou Xin shiteimasu
...
set string136=iie, Li re
set string137=daunrodoZhong 
set string138=.ZIPwodaunrodoZhong 
set string139=Wan Liao ^ ^!
set string140=The .ZIP file is in the directory where RiiConnect24 Patcher is.
set string141=Press any key to go back.
set string142=7zip CLIwodaunrodoZhong 
...
set string167=nee
set string168=RiiConnect24insutorunihaDolphin Emulatorheyoukoso. 
...
set string171=OK! I see that you've exited VFF Downloader Installer.
...
set string204=niyusuchiyanneru
set string376=oTian Qi chiyanneru
set string377=Wiimetsusezi
set string205=minnadeTou Piao chiyanneru
set string206=minnanonintendochiyanneru
set string207=Miikontesutochiyanneru
set string256=Miikontesutochiyanneru
set string257=Miikontesutochiyanneru
set string208=Custom
set string209=You will be asked what you want to patch.
set string210=RiiConnect24woinsutorusuru
...
set string243=Xue Chu suruBi Yao gaarimasu. 
set string244=dekimasuka?
set string245=hai
set string246=iie
...
set string250=Dou Zhi Shi 
set string251=Ci noDou Zhi Shi ni
set string252=Miao 
...
set string329=iie, Li re. 
huairuwoinsutoruZhong 
set string331=out of
set string332=huairunoMing Qian 
set string333=insutoruWan Liao ^ ^! 
...
set string348=Dai tsuteXia sai
...
set string351=ISOhuairu
set string352=WBFShuairu
set string353=Found
...
set string432=RiiConnect24woinsutorusuru.
...
set string435=oTian Qi /niyusuchiyanneru
...
set string468=IOSnopatsuchiwoShi Yong shiteimasu
set string469=niyusuTian Qi Yu Bao chiyannerunipatsuchiwoShi Yong shiteimasu
set string470=Qi nishinaidekudasai shibarakuShi Jian gakakaruKe Neng Xing gaarimasu SDkadonihuairuwokopishiteimasu...
set string471=SDkadowoJie Sok shite, appshuorudatoWADhuorudawoSDkadonorutodeirekutori (meinhuoruda) nikopishitekudasai You can find these folders next to RiiConnect24Patcher.bat
...
set string475=konopatcherwoShi tsutekureteBen Dang niarigatou :)
set string476=RiiConnect24woShi tsuteLe shindekudasai!
set string477=Closing the patcher in:

set string478=intanetsutoniJie Sok sareteimasen
set string478=sabaniJie Sok dekimasen
set string480=intanetsutoJie Sok ya, huaiauorugacurlwoburotsukushiteinaikawoQue Ren shitekudasai
set string481=patsuchinoShi Yong Zhong nieragaFa Sheng shimashita
set string482=erakodo
set string483=Failing module
set string483=hinto: uirusuDui Ce sohutowoYi Shi De niWu Xiao nishitemitekudasai
set string485=Jie Jue Ce : intanetsutoJie Sok woQue Ren shitekudasai
