...
set string50=Nu, du-te în meniul principal.
set string51=Vrei să schimbi la o versiune BETA a patcherului?
set string52=Versiune beta
set string53=Scuze, nu este nicio versiune beta publică disponibilă încă.
set string54=Da, schimbă la ramura Beta.
set string55=[NU AM PUTUT SCHIMBA LA VERSIUNEA BETA]

set string56=AȘTEAPTĂ
set string57=Încerci să oprești actualizarea?
set string58=Te rog amintește-ți faptul că actualizările te țin în siguranță și actualizat cu patcherul.
set string59=Folosește această opțiune doar pentru debugging și depanare.
set string60=Ești sigur ca vrei să oprești actualizarile automate?
...
set string65=Temă albă *ediția te rog nu îmi răni ochii*
...
set string71=Descarc curl... Te rog așteaptă.
set string72=Poate lua ceva timp...

set string73=EROARE.
set string74=A fost o eroare în timpul descărcării curl.
set string75=Vom deschide acum un website care va descărca curl.exe.
set string76=Te rog mută curl.exe în folderul unde patcherul RiiConnect24 este aflat și restartează patcherul.
set string77=Apasă orice tastă pentru a deschide pagina pentru descărcare în browser și pentru a te întoarce în meniu.

set string78=Caut actualizări...
set string79=O actualizare este disponibilă.
set string80=O actualizare pentru acest program este disponibilă. Recomandăm actualizarea patcherului RiiConnect24 la ultima versiune.
...
set string88=Patcherul RiiConnect24 se va restarta în curând...
...
set string101=Înainte să instalezi o aplicație homebrew, vrei să permiți instalarea automată pe SD Cardul tău?
set string102=Da, detecteaza Cardul SD.
set string103=Nu, o să le instalez manual.
set string104=Hmm... se pare că nu s-a găsit un Card SD în consola ta. Te rugăm alege opțiunea "Schimbă litera driveului"
...
set string115=Ne pregătim pentru folosirea instalatorului Open Shop Channel...
set string116=Te rog așteaptă...
set string117=S-a întâmplat o eroare în timpul descărcării Open Shop Channel.
set string118=Codul de Ieșire CURL
set string119=Apasă orice tastă pentru a te întoarce.
set string120=Open Shop Channel Downloader is ready^! Ce vrei să faci acum?
set string121=Arată lista de aplicații homebrew disponibile.
set string122=Descarcă aplicații homebrew.
set string25=Întoarce-te în meniul principal
set string124=Așteaptă un moment...
set string125=SFAT: Ține minte numele aplicației homebrew în care ești interesată, întoarce-te la program, alege "Descarcă aplicații homebrew" și tastează numele.
set string126=Îți va arăta o descriere și alte informații importante despre aplicația homebrew pe care ai ales-o.
set string127=Lista de aplicații homebrew disponibile
...
set string131=Aducem informațiile...
set string132=Tu ai solicitat...
set string133=Descriere lungă:
set string134=Vrei să descarci această aplicație?
set string135=Dacă pornit, va fi instalat automat pe Cardul SD.
set string136=Nu, întoarce-te.
set string137=În curs de descărcare
set string138= .ZIP în curs de descărcare
set string139=Gata^!
set string140= Fișierul .ZIP este localizat în același loc cu patcherul RiiConnect24.
set string141=Apasă orice tastă pentru a te întoarce.
set string142=7zip CLI în curs de descărcare
...
set string145=S-a întâmplat o eroare în timpul descărcării aplicației homebrew de la serverele Open Shop Channel.
set string146=S-a întâmplat o eroare în timpul descărcării 7zip.
...
set string232=Hmm... se pare că nu s-a găsit un Card SD în consola ta. Te rugăm alege opțiunea "Schimbă litera driveului"
