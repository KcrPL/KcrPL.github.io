...
set string107=Bravo^^! Am detectat Cardul tău SD cu succes^^! Litera driveului:
set string108=O să pot descărca și instala tot pe Cardul tău SD automat^^!
...
set string120=Descărcătorul Open Shop Channel este pregătit^^! Ce vrei să faci acum?
