...
cURL Çıkış Kodu
geri dönmek için herhangi bir düğmeye basın.
set string120=Open Shop Channel Downloader is ready^! Sıradaki ne?
...
set string232=Hmm... sisteminizde bir SD Kart bulunamadı gibi görünüyor. Lütfen "Sürücü harfini değiştir" seçeneğini seçin
...
set string235=Congrats^! I've successfully detected your SD Card^! Sürücü harfi:
