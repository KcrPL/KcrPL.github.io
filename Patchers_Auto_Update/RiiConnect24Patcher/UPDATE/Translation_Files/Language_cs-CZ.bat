...
Hurá! Automaticky jsem detekoval SD Kartu! Písmeno jednotky:
set string108=Všechno se automaticky stáhne a zkopíruje tam, kam má! ^^!
...
set string93=Stiskni libovolnou klávesu pro návrat.
set string120=Open Shop Channel Downloader je připraven! Co dál?
...
set string149=Vítej v RiiConnect24 Patcheru! ^^
...
set string167=Hej
set string168=Vítej v RiiConnect24 instalačním procesu pro Dolphin Emulátor.
...
set string202=Expresní (Doporučeno)
set string203=Tohle patchne všechny kanály pro pozdejší použítí s tvojím Wii U. Tohle Obsahuje:
set string204=News Channel (Zprávy)
set string376=Forecast Channel (Počasí)
set string377=Wii Mail (Posílání Zpráv)
set string205=Everybody Votes Channel (Hlasování o různých tématech)
set string206=Nintendo Channel (Nintendo novinky)
set string207=Mii Contest Channel (Mii souteže)
set string256=Mii Contest Channel
set string257=Mii Contest Channel
set string208=Vlastní
set string209=Budeš dotázán co chceš patchnout.
...
set string235=Congrats^! Automaticky jsem detekoval SD Kartu! Písmeno jednotky:
