...
set string235=Congrats^! Ich habe deine SD-Karte erfolgreich erkannt^^! Laufwerksbuchstabe:
...
set string242=One more thing^! Ich habe den WAD-Ordner erkannt.
...
set string259=Alright^! Damit sind wir fertig^!
set string260=Kopieren erfolgreich^! Jede Datei befindet sich auf deiner SD-Karte.
set string261=Wha- Something failed^! Please copy "WAD" and "apps" folders to your SD Card. Sie befinden sich im selben Ordner wie RiiConnect24Patcher.bat
