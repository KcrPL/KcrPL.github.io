...
set string184=USA
set string185=Wir sind fertig^^! Now please open Dolphin, press on Tools and install the WAD file that has been downloaded to the WAD folder 
...
set string280=Since every Wii is different, you will be required to dump keys from your Wii. Es klingt beängstigend, aber keine Sorge, weil wir
