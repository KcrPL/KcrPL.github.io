...
set string107=Congrats^! I've successfully detected your SD Card^! Laufwerksbuchstabe:
...
set string120=Open Shop Channel Downloader is ready^! Was kommt nun?
...
set string226=Habe ich etwas vergessen? Yes^! Um das Patchen noch einfacher zu machen, kann ich alles herunterladen, was du brauchst, und es auf
...
set string235=Congrats^! I've successfully detected your SD Card^! Laufwerksbuchstabe:
...
set string260=Copying successful^! Jede Datei befindet sich auf deiner SD-Karte.
...
set string470=Don't worry^! Es könnte einige Zeit dauern... Kopiere jetzt Dateien auf deine SD-Karte...
