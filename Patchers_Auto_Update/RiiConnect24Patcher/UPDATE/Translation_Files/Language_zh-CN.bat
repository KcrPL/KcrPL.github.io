...
set string3=贡献者
set string4=设置
set string5=在这里管理适用于海豚模拟器的VFF下载器
...
set string18=请转到设置并回退到补丁程序的稳定版本。

set string19=输入你想要执行的命令旁边看到的数字，然后按下回车键。

set string20=故障排除工具
set string21=这个工具可帮助您检测补丁程序的某些问题，并尝试自动修复。
set string22=无法检测到Wii SD卡。
set string23=无法将文件复制到SD卡。
set string24=在重命名文件时发生错误
set string25=返回至主菜单
set string26=选择

set string27=RiiConnect24 补丁程序设置
set string28=返回
set string29=设定背景与文字颜色
set string30=打开/关闭自动更新
set string31=目前值
set string32=更改更新通道至
set string33=Beta（测试版）
set string34=Stable（稳定版）
set string35=修复补丁程序文件
set string36=重新下载
set string37=适用于海豚模拟器的VFF下载器设置
set string38=从您的计算机上完全删除适用于海豚模拟器的VFF下载器
set string39=在启动时删除VFF下载器
set string40=关闭VFF下载器，如果它在运行。
set string41=请稍侯…… 正在提取数据。
set string42=你想将补丁程序回退至稳定版本吗？
set string43=目前版本
set string44=稳定版本
set string45=抱歉，但在提取数据时发生错误。
set string46=你想更改更新通道吗？
set string47=开始更新。
set string48=是的，更换到Stable（稳定版）通道。
set string49=【无法切换至Stable通道】
set string50=不是，返回至主菜单。
set string51=你想将补丁程序更换至测试版本吗？
set string52=测试版本
set string53=抱歉，但现在没有可用的公共测试版本。
set string54=是的，更换到Beta（测试版）通道。
set string55=【无法切换至Beta通道】

set string56=欸等等
set string57=你要停止接收更新吗？
...
set string153=海豚模拟器（Dolphin Emulator）
set string154=Choose wisely

set string155=我应该怎么工作？
set string156=为海豚模拟器安装RiiConnect24
set string191=为Wii U安装RiiConnect24
set string273=为Wii安装RiiConnect24
set string274=从Wii里移除RiiConnect24。
...
set string433=这个选项将会为你的Wii下载并为所有可用的频道打补丁。 包括：
...
set string441=你知道吗？RiiConnect24 的 LOGO 是 NeoRame 设计的，他也为 Wiimmfi 设计过 LOGO。
