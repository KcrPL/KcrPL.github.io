...
set string447=The blinking blue light that indicates a system message has been received is actually synced to the bird call of the Japanese bush warbler. Больше информации про это можно найти на YouTube канале RiiConnect24^^!
