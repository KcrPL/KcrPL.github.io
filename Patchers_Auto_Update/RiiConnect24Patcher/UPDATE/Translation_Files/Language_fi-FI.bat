...
set string5=hallitse VFF Lataaja Dolphinille täällä
...
set string32=Vaihda päivittävä haara
set string33=Beeta
set string34=Vakaa
...
set string39=Poista VFF Lataaja käynnistyksestä
set string40=Jos VFF lataaja on päällä, sammuta se.
set string41=Odota hetki... haetaan dataa.
set string42=Haluatko siirtyä takaisin vakaampaan versioon patcherista?
set string43=Nykyinen versio
set string44=Vakaa versio
set string45=Pahoittelut, datan hakemisessa tapahtui virhe.
set string46=Haluatko vaihtaa haarojen välillä?
set string47=Päivityksen käsittely alkaa.
set string48=Kyllä, vaihda vakaaseen haaraan.
set string49=[EI VOITU VAIHTAA VAKAAMPAAN VERSIOON]
set string50=Ei, mene takaisin päävalikkoon.
set string51=Haluatko siirtyä BEETA versioon patcherista?
set string52=Beeta versio
set string53=Pahoittelut, julkista beeta versiota ei ole tällä hetkellä saatavilla.
set string54=Kyllä, vaihda Beeta haaraan.
set string55=[EI VOITU SIIRTYÄ BEETA VERSIOON]

set string56=ODOTA
set string57=Yritätkö kytkeä pois päältä päivittämisen?
set string58=Muista että päivitykset pitävät sinut turvassa ja päivitettynä patcherissa.
set string59=Käytä tätä vaihtoehtoa vain debuggaamiseen ja vianetsintään.
set string60=Oletko varma, että haluat kytkeä pois päältä automaattisetpäivitykset?

set string61=Kyllä
set string62=Ei, mene takaisin.

set string63=Vaihda väri:
set string64=Tumma teema
set string65=Vaalea teema *Älä satuta minun silmiäni*
set string66=Vaalea teema *Kyllä satuta minun silmät*
set string67=Keltainen
set string68=Vihreä
set string69=Punainen
set string70=Sininen

set string71=Ladataan curl... Ole hyvä ja odota.
set string72=Tämä voi kestää jonkinaikaa...

set string73=VIRHE.
set string74=Esiintyi virhe ladattaessa curl.
set string75=Avaamme nyt sivun, joka lataa curl.exe.
set string76=Siirrä curl.exe RiiConnect24 Patcherin kansioon ja käynnistä patcher uudelleen.
set string77=Paina mitä tahansa näppäintä avataaksesi lataus sivun selainmessa ja palaa päävalikkoon.

set string78=Tarkistetaan päivityksiä...
set string79=Päivitys on saatavilla.
set string80=Päivitys tälle ohjelmalle on saatavilla. Suosittelemme lataamaan RiiConnect24 Patcherin viimeisinpään versioon.
set string81=Nykyinen versio
set string82=Uusi versio
set string83=Päivitä
set string84=Hylkää
set string85=Mitä uutta on tässä päivityksessä?
set string86=Päivitetään.
set string87=Odota hetki...
set string88=RiiConnect24 Patcher käynnistyy pian uudelleen...
set string74=Esiintyi virhe ladattaessa päivitys avustajaa.
set string90=Paina mitä tahansa näppäintä palataaksesi päävalikkoon.
set string91=Mitä uutta on päivityksessä
set string92=Virhe. Mitä uutta tiedosto ei ole saatavilla.
set string93=Paina mitä tahansa näppäintä palataaksesi takaisin.
:: Local end

:: Must be available online
set string100=Tervetuloa Homebrew Kauppaan.
set string101=Ennen kun lataat homebrewiä, haluatko kytkeä päälle automaattisen asennuksen SD Kortille?
set string102=Kyllä, tunnista SD Kortti.
set string103=Ei, asennan ne manuaalisesti.
set string104=Hmm... näyttää siltä että SD Korttia ei löytynyt tietokoneeltasi. Valitse `Vaihda aseman kirjain` valinta
set string105=Asettaaksesi SD Kortti aseman kirjaimen manuaalisesti.
set string106=Muuten sinun täytyy kopioida homebrewit SD Kortille manuaalisesti.
...
set string109=Mitä seuraavaksi?
set string110=Jatka
...
set string115=Valmistellaan Open Shop Kanava lataajan käyttöä...
...
set string119=Paina mitä tahansa näppäintä mennäksesi takaisin.
set string120=Open Shop Channel Downloader is ready^! Mitä seuraavaksi?
set string121=Näytä lista mitä homebrewiä on saatavilla.
set string122=Lataa homebrewiä.
set string123=Palaa päävalikkoon
set string124=Yksi hetki odota...
set string125=VIHJE: Muista homebrew sovelluksen nimi johon olet kiinnostunut, palaa ohjelmaan, valitse "Lataa homebrewiä" ja kirjoita se.
set string126=Se näyttää sinulle kuvauksen ja muuta hyödyllistä tietoa homebrewistä, jonka olet valinnut.
set string127=Lista Homebrewiä saatavilla
set string128=Kirjoita homebrewin nimi.
set string129=ei ole servereillä saatavilla.
set string130=Jos haluat nähdä listan homebrewejä, jotka ovat servereillä palaa takaisin ja valitse "Näytä lista homebrewiä saatavilla".
set string131=Haetaan dataa...
set string132=Olet pyytänyt...
set string133=Pitkä kuvaus:
set string134=Haluatko ladata tämän sovelluksen?
set string135=Jos on kytketty päälle, se asentuu SD Kortillesi automaattisesti.
...
set string119=Paina mitä tahansa näppäintä palataaksesi takaisin.
set string142=Ladataan 7zip CLI
set string143=Puretaan homebrew sovellus SD Kortillesi...
set string144=Esiintyi virhe ladatessa homebrewiäsi.
set string145=Esiintyi virhe ladatessa homebrewiä Open Shop Kanavan serveriltä.
...
set string232=Hmm... näyttää siltä että SD Korttia ei löytynyt tietokoneeltasi. Valitse `Vaihda aseman kirjain` valinta
