...
set string107=Congrats^! I've successfully detected your SD Card^! Буква диска:
...
set string120=Open Shop Channel Downloader is ready^! Что дальше?
...
set string447=Мигающий синий свет дисковода который означает о получении системного сообщения на самом деле синхронизирован с птичьим зовом Японского соловья. More info about it on RiiConnect24 YouTube Channel^!
...
set string470=Don't worry^! Это может занять некоторое время... Копируем файлы на вашу SD-карту...
