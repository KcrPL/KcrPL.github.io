...
set string6=Exécuter le Téléchargeur de VFF une fois.
...
set string45=Désolé, il y a eu une erreur durant la récupération des données.
...
set string58=S'il vous plaît retenez que ces mises à jour vous garderons en sécurité et à jour au niveau du patcher.
set string59=Veuillez utiliser cette option pour débugger et/ou dépanner.
set string60=Vous êtes sure que vous voulez désactiver les mises à jour automatiques?

set string61=Oui
set string62=Non, retourner en arrière.

set string63=Changer la couleur:
set string64=Thème sombre
set string65=Thème clair *version ne me faites pas mal aux yeux svp*
...
set string73=ERREUR.
set string74=Il y a eu une erreur pendant le téléchargement de curl.
...
set string104=Hmm... aucune carte SD n’a été trouvée dans votre système. S'il vous plait, Veuillez choisir l'option "Change drive letter"
set string105=Pour choisir la lettre de la Carte SD manuellement.
set string106=Sinon, tu devras copier l'homebrew manuellement sur la carte SD.
set string107=Félicitations ^! J'ai réussi à détecter ta carte SD^! Lettre du disque:
set string108=Je vais pouvoir automatiquement tout télécharger et installer sur votre Carte SD ^!
...
set string114=Tapez la lettre de votre disque (ex: H)
set string115=Préparation pour l'utilisation avec l'Open Shop Channel downloader...
set string116=Veuillez patienter...
set string117=Il y a eu une erreur durant le téléchargement de l'Open Shop Channel downloader.
set string118=Code d'erreur Curl
set string119=Appuyer sur n’importe quel bouton pour revenir.
set string120=L'Open Shop Channel Downloader est prêt^! Et maintenant?
set string121=Afficher la liste d'homebrew disponible.
set string122=Télécharger l'homebrew.
set string123=Retourner au menu principal
set string124=Une seconde s’il te plait...
set string125=ASTUCE: Retenez le nom de l'homebrew dont vous êtes intéressé, revenez sur le programme et sélectionnez "Télécharger l'homebrew" et mettez son nom.
...
set string185=We're done^! Maintenant, veuillez s’il vous plaît ouvrir l’émulateur Dolphin, appuyer sur le bouton outils et installer le fichier WAD qui a été téléchargé dans le dossier WAD 
...
set string235=Congrats^! J'ai réussi à détecter ta carte SD^! Lettre du disque:
...
set string242=One more thing^! J'ai détecté un dossier "WAD".
...
set string260=Copying successful^! Tout les fichiers sont sur la Carte SD.
set string261=Wha- Something failed^! S'il vous plait, copier les dossiers "WAD" et "apps" dans votre Carte SD. Ils sont a coté de RiiConnect24Patcher.bat
