...
set string41=Veuillez patienter... I'm currently installing xyzzy-mod on your SD Card.
...
set string259=Et voilà ^^! I've successfully installed xyzzy-mod on your SD Card. I will remove it once this step is done.
