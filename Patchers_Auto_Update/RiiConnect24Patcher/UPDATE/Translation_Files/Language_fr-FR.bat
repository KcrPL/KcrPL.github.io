...
set string374=Ceci vous aidera à désinstaller RiiConnect24 de votre Wii.
...
setstring212=Démarrer le patch ^!
...
set string259=Et voilà ^! J'ai installé avec succès xyzzy-mod sur votre carte SD. Je le supprimerai une fois cette étape terminée.
