...
set string226=Ai-je oublié quelque chose? Yes^! Pour que le correctif soit encore plus facile, je peut télécharger tout ce que vous avez besoin et le mettre sur
...
set string235=Congrats^! Votre carte SD a bien été détectée ^! Lettre du disque:
...
set string279=Ceci est l'écran de configuration de wad2bin. You will be required to do this step only once.
