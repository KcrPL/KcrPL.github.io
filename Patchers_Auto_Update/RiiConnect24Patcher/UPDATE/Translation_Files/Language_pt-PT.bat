...
set string17=Se não sabes o que estás a fazer, por favor dirige-te às definições e volta a
...
set string20=Ferramentas de resolução de problemas
set string21=Estas ferramentas devem ajudar a diagnosticar alguns problemas com o patcher e ajudar a repará-los automaticamente.
set string22=Não foi possível detetar o cartão SD.
set string23=Não foi possível copiar ficheiros para o cartão SD.
set string24=Erro ao renomear os arquivos
set string25= Regressar ao menu principal
set string26=Escolhe

set string27=Definições do Patcher RiiConnect24
set string28=Volta para trás
set string29=Definir cor de fundo e cor do texto
set string30=Ligar/Desligar atualizações
set string31=Atualmente
set string32=Mudar ramo de atualizações para
set string33=Beta
set string34=Estável
set string35=Reparar ficheiro do patcher
set string36=Descarregar de novo
set string37=Definições do VFF Downloader for Dolphin
...
set string40=Se o VFF Downloader estiver em execução, desligá-lo.
set string41=Por favor aguarde... A obter dados.
set string42=Queres voltar à versão estável do patcher?
...
set string47=O processo de atualização irá começar.
set string48=Sim, muda para um branch estável.
set string49=[NÃO FOI POSSÍVEL MUDAR PARA UMA VERSÃO ESTÁVEL]
set string50=Não, volta para o menu principal.
set string51=Queres mudar para uma versão BETA do patcher?
set string52=Versão Beta
set string53=Desculpa, não existe uma versão beta pública disponível neste momento.
set string54=Sim, muda para um branch Beta.
set string55=[NÃO FOI POSSÍVEL MUDAR PARA UMA VERSÃO BETA]

set string56=ESPERA
set string57=Estás a tentar desativar as atualizações?
set string58=Por favor, lembra-te que essas atualizações mantêm-te seguro e atualizado sobre o patcher.
set string59=Utiliza esta opção só para depuração e resolução de problemas.
set string60=Tens a certeza que queres desativar as atualizações automáticas?
...
set string76=Por favor move o curl.exe para a pasta onde o patcher do RiiConnect24 está e reinicia o patcher.
set string77=Clica em qualquer tecla para abrires uma página de download num browser e para regressares ao menu.

set string78=A procurar atualizações...
set string79=Uma atualização está disponível.
set string80=Uma atualização para este programa está disponível. Recomendamos atualizares o patcher do RiiConnect24 para a sua última versão.
set string81=Versão atual
set string82=Versão nova
...
set string276=Instalar ficheiros WAD diretamente no Cartão SD - wad2bin.
...
set string446=É possível usar velas como uma Barra de Sensor para a Wii.
...
set string473=Você pode encontrar essas pastas ao lado do RiiConnect24Patcher.bat.
...
set string483=Módulo a falhar
set string484=DICA: Tenta desligar o seu antivirus temporariamente.
set string485=SOLUÇÃO: Verifique a sua conexão de Internet.
...
set string487=SOLUÇÃO: Por favor instala a versão mais recente do .NET Framework e tenta outra vez.
