...
set string107=Congrats^! I've successfully detected your SD Card^! Meghajtóbetűjel:
...
set string120=Open Shop Channel Downloader is ready^! Mi legyen?
...
set string185=We're done^! Most nyisd meg a Dolphin Emulátort, kattints az „Eszközök” menüben a „WAD telepítése...” lehetőségre 
...
set string226=Kimaradt volna valami...? Yes^! A dolgod megkönnyítése érdekében a program minden szükséges dolgot
...
set string235=Congrats^! I've successfully detected your SD Card^! Meghajtóbetűjel:
...
set string242=One more thing^! Van egy WAD mappa a kártyán.
