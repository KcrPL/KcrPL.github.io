...
set string102=Sì, trova la scheda SD.
set string103=No, gli installo manualmente.
...
set string232=Hmm... sembra che non sia stata trovata una scheda SD nel tuo sistema. Scegli l'opzione `Cambia lettera drive`
...
set string235=Congrats^^! Ho trovato con successo la tua scheda SD^^! Lettera drive:
