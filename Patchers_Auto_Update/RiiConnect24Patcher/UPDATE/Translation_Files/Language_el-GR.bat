...
set string35=Επιδιώρθοση αρχείων προγράμματος
set string36=Ξανακατέβασε
set string37=VFF Downloader για Ρυθμίσεις του Dolphin
set string38=Τελείως διάγραψε τον VFF Downloader για το Dolphin από τον υπολογιστή σου
...
set string41=Παρακαλώ περίμενε... ανακτούνται δεδομένα.
...
set string45=Συγγνώμη, αλλά υπήρξε ένα πρόβλημα ενώ ανακτούνταν δεδομένα.
set string46=Θέλεις να αλλάξεις τύπο έκδοσης;
