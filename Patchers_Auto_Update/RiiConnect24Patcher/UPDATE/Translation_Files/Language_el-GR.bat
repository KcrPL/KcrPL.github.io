...
set string2=Ξεκίνα
set string3=Ευχαριστίες
set string4=Ρυθμίσεις
...
set string8=Στείλε μας mail στο support@riiconnect24.net
set string9=Ανιχνεύτηκε κάρτα μνήμης SD του Wii:
set string10=Δεν μπορούσε να ανιχνευτεί κάρτα μνήμης SD.
set string12=Ανανέωση
set string12=Αν είναι λάθος, μπορεί να γίνει αλλαγή αργότερα.

set string13=Προειδοποίηση
set string14=Χρησιμοποιείς μια πειραματική έκδοση αυτού του προγράμματος.
set string15=Αυτό σημαίνει πως αυτή η έκδοση μπορεί να περιέχει πειραματικά χαρακτηριστικά
set string16=και σφάλματα που μπορεί να χαλάσουν το Wii/Wii U σου ή τον υπολογιστή σου.
set string17=Αν δεν ξέρεις τι κάνεις παρακαλώ πήγαινε στις ρυθμίσεις και πήγαινε πίσω στη
set string18=σταθερή έκδοση του προγράμματος.

set string19=Πληκτρολόγησε έναν αριθμό πού μπορείς να δεις παραπάνω, δίπλα από την εντολή και πάτα ENTER

set string20=Εργαλεία επίλυσης προβλημάτων
set string21=Αυτά τα εργαλεία θα σε βοηθήσουν να εντοπίσεις κάποια σφάλματα με το πρόγραμμα και θα προσπαθήσουν να επιλυθούν αυτόματα.
set string22=Δεν μπόρεσε να ανιχνευτεί κάρτα μνήμης SD.
set string23=Δεν ήταν δυνατό να αντιγραφούν αρχεία στη κάρτα μνήμης SD.
set string24=Σφάλμα μετονομασίας αρχείων
set string25=Πήγαινε πίσω στο κυρίως μενού
set string26=Επίλεξε

set string27=Ρυθμίσεις RiiConnect24 Patcher
set string28=Πήγαινε πίσω
set string29=Όρισε χρώμα ταπετσαρίας/κειμένου
set string30=Ενεργοποίησε/απενεργοποίησε την ενημέρωση του Patcher
set string31=Τώρα
set string33=Άλλαξε κλάδο αναβάθμισης σε
set string33=Πειραματική
set string34=Σταθερή
set string35=Επιδιόρθωση αρχείων προγράμματος
set string36=Λήψη του Patcher ξανά
set string37=VFF Downloader για Ρυθμίσεις του Dolphin
set string38=Πλήρης διαγραφή του VFF Downloader για το Dolphin από τον υπολογιστή σου
set string39=Αφαίρεσε τον VFF Downloader από την εκκίνηση του υπολογιστή
set string40=Αν τρέχει ο VFF Downloader, κλείσε τον.
set string41=Παρακαλώ περίμενε... ανάκτηση δεδομένων.
set string42=Θέλεις να πας πίσω στη σταθερή έκδοση του προγράμματος;
set string43=Έκδοση προγράμματος
set string44=Σταθερή έκδοση
set string45=Συγγνώμη, αλλά υπήρξε ένα πρόβλημα στην ανάκτηση δεδομένων.
set string46=Θέλεις να αλλάξεις κλάδο έκδοσης;
set string47=Διαδικασία αναβάθμισης θα ξεκινήσει.
set string48=Ναι, άλλαξε την έκδοση του προγράμματος σε σταθερή.
set string49=[ΔΕΝ ΗΤΑΝ ΕΠΙΤΥΧΗΣ Η ΑΛΛΑΓΗ ΣΕ ΣΤΑΘΕΡΗ ΕΚΔΟΣΗ]
set string50=Όχι πήγαινε πίσω στο κυρίως μενού.
set string51=Θέλεις να αλλάξεις την έκδοση του patcher σε πειραματική;
set string 52=Πειραματική έκδοση
set string53=Συγγνώμη, δεν υπάρχει πειραματική έκδοση αυτή τη στιγμή.
set string54=Ναι, άλλαξε σε πειραματικό κλάδο.
